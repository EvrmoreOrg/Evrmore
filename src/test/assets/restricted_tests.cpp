...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler evr tx
        CScript evrTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut evrOut(1*COIN, evrTransfer);
        ...
        mutTxTest1.vout.emplace_back(evrOut);
        ...
        mutTxTest2.vout.emplace_back(evrOut);
        ...
        mutTxTest3.vout.emplace_back(evrOut);
        ...
        mutTxTest4.vout.emplace_back(evrOut);
        ...
        mutTxTest5.vout.emplace_back(evrOut);
        ...
        mutTxTest6.vout.emplace_back(evrOut);
        ...
        mutTxTest7.vout.emplace_back(evrOut);
        ...
        mutTxTest8.vout.emplace_back(evrOut);
