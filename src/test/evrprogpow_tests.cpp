...
BOOST_FIXTURE_TEST_SUITE(evrprogpow_tests, BasicTestingSetup)

BOOST_AUTO_TEST_CASE(evrprogpow_l1_cache)
{
...
BOOST_AUTO_TEST_CASE(evrprogpow_hash_empty)
{
    auto& context = get_ethash_epoch_context_0();
...
BOOST_AUTO_TEST_CASE(evrprogpow_hash_30000)
{
...
BOOST_AUTO_TEST_CASE(evrprogpow_hash_and_verify)
{
...
BOOST_AUTO_TEST_CASE(evrprogpow_search)
{
