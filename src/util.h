 ...
 */
#ifndef EVRMORE_UTIL_H
#define EVRMORE_UTIL_H
...
extern const char *const EVRMORE_CONF_FILENAME;
extern const char *const EVRMORE_PID_FILENAME;
...
{
    std::string s = strprintf("evrmore-%s", name);
