...
#ifndef EVRMORE_QT_EVRMOREUNITS_H
#define EVRMORE_QT_EVRMOREUNITS_H
...
/** Evrmore unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EvrmoreUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EvrmoreUnits(QObject *parent);
...
typedef EvrmoreUnits::Unit EvrmoreUnit;

#endif // EVRMORE_QT_EVRMOREUNITS_H
