...
#ifndef EVRMORE_QT_EVRMOREGUI_H
#define EVRMORE_QT_EVRMOREGUI_H
...
/**
  Evrmore GUI main class. This class represents the main window of the Evrmore UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EvrmoreGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit EvrmoreGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~EvrmoreGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Evrmore wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QComboBox *comboEvrUnit = nullptr;
