...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(EvrmoreUnits::EVR),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->evrBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->evrBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(EvrmoreUnits::formatWithUnit(unit, balance, false, EvrmoreUnits::separatorAlways));
    ui->labelUnconfirmed->setText(EvrmoreUnits::formatWithUnit(unit, unconfirmedBalance, false, EvrmoreUnits::separatorAlways));
    ui->labelImmature->setText(EvrmoreUnits::formatWithUnit(unit, immatureBalance, false, EvrmoreUnits::separatorAlways));
    ui->labelTotal->setText(EvrmoreUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, EvrmoreUnits::separatorAlways));
    ui->labelWatchAvailable->setText(EvrmoreUnits::formatWithUnit(unit, watchOnlyBalance, false, EvrmoreUnits::separatorAlways));
    ui->labelWatchPending->setText(EvrmoreUnits::formatWithUnit(unit, watchUnconfBalance, false, EvrmoreUnits::separatorAlways));
    ui->labelWatchImmature->setText(EvrmoreUnits::formatWithUnit(unit, watchImmatureBalance, false, EvrmoreUnits::separatorAlways));
    ui->labelWatchTotal->setText(EvrmoreUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, EvrmoreUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("EVR")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the EVR balance grid from expanding and looking terrible when asset balance is hidden
