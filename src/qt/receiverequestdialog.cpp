...
#include "config/evrmore-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatEvrmoreURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + EvrmoreUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatEvrmoreURI(info));
}
