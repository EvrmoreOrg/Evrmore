    ...
    mapper(0)
{
    ...
    ui->evrmoreAtStartup->setToolTip(ui->evrmoreAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->evrmoreAtStartup->setText(ui->evrmoreAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openEvrmoreConfButton->setToolTip(ui->openEvrmoreConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new EvrmoreUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->evrmoreAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openEvrmoreConfButton_clicked()
{
