...
#include "qt/evrmoreamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<EvrmoreAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_evrmore-qt -platform xcb      # Linux
//     src/qt/test/test_evrmore-qt -platform windows  # Windows
//     src/qt/test/test_evrmore-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = EvrmoreUnits::formatWithUnit(unit, balance, false, EvrmoreUnits::separatorAlways);
    ...
    // Amount input
    EvrmoreAmountField* amountInput = receiveCoinsDialog.findChild<EvrmoreAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: evrmore:")) != -1);
