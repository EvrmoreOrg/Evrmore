...
#ifndef EVRMORE_PROTOCOL_H
#define EVRMORE_PROTOCOL_H
...
/**
 * Evrmore protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Evrmore Core nodes, and is unset by SPV clients or other peers that just want
    ...
    // evrmore-development mailing list. Remember that service bits are just
