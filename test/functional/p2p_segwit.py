...
class UTXO:
    ...
    def __init__(self, sha256, n, n_value):
        self.sha256 = sha256
        self.n = n
        self.nValue = n_value
...
class TestNode(NodeConnCB):
    ...
    def announce_tx_and_wait_for_getdata(self, tx, timeout=60):
        ...
        self.send_message(MsgInv(inv=[CInv(1, tx.sha256)]))
    ...
    def announce_block_and_wait_for_getdata(self, block, use_header):
        ...
        if use_header:
            ...
            self.send_message(MsgInv(inv=[CInv(2, block.sha256)]))
...
class SegWitTest(EvrmoreTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, evrmored delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let evrmored fill it in.
    ...
    def test_signature_version_1(self):
        ...
        for i in range(NUM_TESTS):
            ...
            for j in range(num_inputs):
                tx.vin.append(CTxIn(COutPoint(temp_utxos[j].sha256, temp_utxos[j].n), b""))
                tx.wit.vtxinwit.append(CTxInWitness())
            ...
            for idx in range(num_outputs):
                temp_utxos.append(UTXO(tx.sha256, idx, split_value))
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older evrmored's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-evrmored> to
    # the test.
    def test_upgrade_after_activation(self, node_id):
        self.log.info("Testing software upgrade after softfork activation")

        assert (node_id != 0)  # node0 is assumed to be a segwit-active evrmored
