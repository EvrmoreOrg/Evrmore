...
class TestEvrmoreCli(EvrmoreTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `evrmore-cli getinfo`")
        ...
        self.log.info("Compare responses from `evrmore-cli -getinfo` and the RPCs data is retrieved from.")
