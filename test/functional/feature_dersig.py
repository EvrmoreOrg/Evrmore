...
class BIP66Test(EvrmoreTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # evrmored is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and evrmored produces more specific reject
            # reasons.
