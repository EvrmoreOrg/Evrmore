...
This document provides guidelines for internationalization of the Evrmore Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `evrmore_en.ts` remains unchanged.
